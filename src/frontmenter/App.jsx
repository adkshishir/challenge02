import daily, { monthly, weekly } from "./alldata";
import png from "./images/image-jeremy.png";
...
const cart = (duration) =>
  duration.map((du) => {
    ...
    if (du.title === "Exercise") {
      colors = "hsl(145, 58%, 55%)";
      icons = (
...
function App() {
  ...
  return (
    <div className="app ">
      <div className=" item blueframe">
        <div className="profile">
          <img className="profile-img " src={png} />
          <div>
            <p>Report for</p>
            <h1>Jeremy Robson</h1>
          </div>
        ...
        <div className="btn-container">
          ...
          <button className={btn2} onClick={() => setTime(weekly)}>
            weekly
          </button>
          <button className={btn3} onClick={() => setTime(monthly)}>
            monthly
          </button>
        </div>
      </div>
...
const Cart = ({ task, current, previous, styles, icons }) => {
  return (
    <div className="cartContainer item " style={{ backgroundColor: styles }}>
      <div className="cart-icons">{icons}</div>
      <div className="works-container blueframe item">
        <div className="cart-title">
          <div>{task}</div>
          <div>...</div>
        </div>
        <div className="cart-main">
          <div className="time">{current} hrs</div>
          <div className="cart-footer">
            Last {days} -{previous}hrs
          </div>
        </div>
      </div>
    </div>
